...
public class SList {
    ...
    public static void main (String[] args) {
        ...
        System.out.println("construct a list that looks like: [ 6 9 12 ] and print the resulting list.");
        ...
        System.out.println("Add more lines to change this list to: [ 3 6 9 12 15 ] and print the resulting list.");
